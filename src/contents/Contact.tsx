...
const contacts = [
    ...
    },
    {
        label: "LinkedIn",
        value: "Munirah Muda",
        href: "https://www.linkedin.com/in/munirah-muda-37bab8352",
        icon: "✦",
    },
];
    ...
    return (
        <Box
            ...
            sx={{
                ...
                boxShadow: hovered && href ? '0 16px 40px rgba(0,153,120,0.3), 0 4px 12px rgba(0,0,0,0.4)' : 'none',
...
const Contacts: React.FC = () => {
    return (
        <Box id="contact" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', px: { xs: 2, md: 4 }, py: 6 }}>
            ...
            <Typography sx={{ fontFamily: 'serif', fontSize: { xs: '0.95rem', md: '1.1rem' }, fontStyle: 'italic', color: 'rgba(255,255,255,0.5)', mb: 5, textAlign: 'center' }}>
